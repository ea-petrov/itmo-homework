...
`https://www.kgeorgiy.info/git-students/year2024/<USER>/paradigms`,
 ...
 * Клонируйте ваш личный репозиторий
    * `git clone https://www.kgeorgiy.info/git-students/year2024/<USER>/paradigms`
 ...
 * Добавьте ссылку на исходный репозиторий
    * `git remote add source https://www.kgeorgiy.info/git/geo/paradigms-2025-students`
